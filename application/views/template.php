...
<head>
  ...
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
   <!-- Icon Web -->
  <link rel="icon" href="<?= base_url('assets/images/arsip4.png') ?>" type="image/x-icon">
  <!-- Bootstrap 3.3.7 -->
...
<body class="hold-transition skin-purple-light sidebar-mini <?=$this->uri->segment(1) == 'sale'? 'sidebar-collapse' : null?>">
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=site_url('dashboard');?>" class="logo">
      ...
      <span class="logo-lg"><i class="fas fa-envelope-open-text"></i> <b>Arsip Surat</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="user-header pull-left" style="font-size: 100%; font-weight: bold; font-style: italic;"><a href="#">Sistem Informasi Arsip Surat</a></li>
         

          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=base_url()?>assets/images/arsip4.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?=ucfirst($this->fungsi->user_login()->username)?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?=base_url()?>assets/images/arsip4.png" class="img-circle" alt="User Image">
...
<script src="<?=base_url()?>assets/bower_components/jquery/dist/jquery.min.js"></script>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; Oktober 2021 <a href="#">Gita Kartika Pariwara</a>.</strong> Politeknik Negeri Malang.
  </footer>
